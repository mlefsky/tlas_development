...
plt.clf()
v1,v2,d=tmp
v1_maxz=plot_voxel_slice(v1['voxels'][250:400,200,:],v1,title='Transect',show_image=True)
v2_maxz=plot_voxel_slice(v2['voxels'][250:400:,200,:],v1,title='Transect',show_image=False)
