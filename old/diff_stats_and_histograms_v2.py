...
#    print(mask.shape)
    ...
    print("LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLsLOM",meta['count'],in_image)
    sys.exit()
...
#                print(ix,len(all_index2),match_ix,len(baseline_index2))
                ...
                tmp1=np.nan_to_num(tmp1, nan=-9999.0, posinf=None, neginf=None)
                tmp2=np.nan_to_num(tmp2, nan=-9999.0, posinf=None, neginf=None)
                tmp1_back=tmp1
                tmp2_back=tmp2
...
s=match_and_substract(ef,"/home/ubuntu/density_comparison_v2/multistack2_v2.tif",title)
